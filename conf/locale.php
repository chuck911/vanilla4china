...
$Definition['%s discussion'] = '%s 讨论';
$Definition['%s discussions'] = '%s 讨论';
...
$Definition['1 month after being sent'] = '一个月后发送';
$Definition['1 week after being sent'] = '一个星期后发送';
$Definition['2 weeks after being sent'] = '两个星期后发送';
...
$Definition['Add a Profile Picture'] = '设置头像';
...
$Definition['Application Secret'] = '应用密码';
$Definition['ApplicationHelp'] = '应用程序允许你增加一大群功能到您的网站。<br />一旦申请被添加到您的%s文件夹, 你可以在这里启用或禁用它。';
...
$Definition['Configure an Authenticator'] = '配置认证';
...
$Definition['ErrorRecordNotFound'] = '你请求的数据未找到.';
$Definition['ErrorTermsOfService'] = '你必须同意服务条款.';
...
$Definition['HeadlineFormat.Registration'] = '{ActivityUserID,You} 加入.';
$Definition['HeadlineFormat.PictureChange.ForUser'] = '{RegardingUserID,You} 更换了 {ActivityUserID,your} 头像.';
...
$Definition['Most recent: %1$s by %2$s'] = '最近更新 %1$s 最新评论来自 %2$s';
...
$Definition['Sign In with Twitter'] = '用Twitter帐号登录';
...
$Definition['Username can only contain letters, numbers, underscores, and must be between 3 and 20 characters long.'] = '用户名不能包含非法字符. 长度不能少于两个字符.';
$Definition['Users'] = '用户';
...
// Last edited by chuck911 (127.0.0.1)2012-03-21 15:49:18

$Definition['Edit My Profile'] = '编辑我的个人信息';
$Definition['Edit Profile'] = '编辑个人信息';
$Definition['Ban'] = '阻止访问';
$Definition['Recent Discussions'] = '最新讨论';
$Definition['All Categories'] = '所有分类';
$Definition['Leave a Comment'] = '发言';
$Definition['Home'] = '主页';

/* admin */
$Definition['Getting Started'] = '快速开始';
$Definition['Help &amp; Tutorials'] = '帮助 &amp; 教程';
$Definition['Homepage'] = '首页设定';
$Definition['Change Log'] = '改动日志';
$Definition['Moderation'] = '内容管理';
$Definition['Banning'] = '禁止访问';
$Definition['Flood Control'] ='频率控制';
